...
## Installation
1. Download <a href="https://github.com/QChASM/ChimAARON/raw/dev/dist/SEQCROW-0.20-py3-none-any.whl" target="_blank">SEQCROW-0.20-py3-none-any.whl</a>
2. Open ChimeraX
3. On the ChimeraX command line, enter `toolshed install /path/to/SEQCROW-0.20-py3-none-any.whl`
4. Restart ChimeraX
