...
### GitHub
1. Download <a href="https://github.com/QChASM/SEQCROW/raw/master/dist/SEQCROW-1.9.0a2-py3-none-any.whl">SEQCROW-1.9.0a2-py3-none-any.whl</a>
2. Open ChimeraX
3. (if updating SEQCROW) On the ChimeraX command line, enter `toolshed uninstall SEQCROW` and restart ChimeraX
4. On the ChimeraX command line, enter `toolshed install /path/to/SEQCROW-1.9.0a2-py3-none-any.whl`
5. Restart ChimeraX
