...
## Installation
1. open ChimeraX
2. on the command line, enter `toolshed install /path/to/ChimAARON-0.1-py3-none-any.whl`
3. close ChimeraX
...
5. If you have a personal AaronTools library already, you can specify the path to it in the ChimAARON settings. Open ChimeraX and go Favorites &rarr; Settings... &rarr; ChimAARON. You will have to restart ChimeraX if you change this setting. 
