...
## Installation
1. Download <a href="https://github.com/QChASM/SEQCROW/raw/dev/dist/SEQCROW-1.0.2b1-py3-none-any.whl">SEQCROW-1.0.2b1-py3-none-any.whl</a>
2. Open ChimeraX
3. On the ChimeraX command line, enter `toolshed install /path/to/SEQCROW-1.0.2b1-py3-none-any.whl`
4. Restart ChimeraX
