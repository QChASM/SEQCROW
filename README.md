...
### GitHub
1. Download <a href="https://github.com/QChASM/SEQCROW/raw/master/dist/seqcrow-1.9.3-py3-none-any.whl">seqcrow-1.9.3-py3-none-any.whl</a>
2. Open ChimeraX
3. (if updating SEQCROW) On the ChimeraX command line, enter `toolshed uninstall SEQCROW` and restart ChimeraX
4. On the ChimeraX command line, enter `toolshed install /path/to/seqcrow-1.9.3-py3-none-any.whl`
5. Restart ChimeraX
