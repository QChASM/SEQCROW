...
class InputManager:
    ...
    def newRecord(self, name, model_str, *args, **kwargs):
        ...
        self.records[name] = [InputRecord(name, cats, *args, **kwargs)]
    ...
    def mapLigand(self, name, positions, ligand_name, hiddenEntry, replaceOld, ligPrefix=None):
        ...
        self.records[name].append(InputRecord(name, new_cat_dict, ligPrefix=ligPrefix, ligand=ligand_name, hidden=hiddenEntry))
    ...
    def subSomething(self, name, chim_atoms, sub_name, hiddenEntry, replaceOld, ligPrefix=None, subPrefix=None):
        ...
        self.records[name].append(InputRecord(name, new_cat_dict, \
                                               ligPrefix=ligPrefix, \
                                               subPrefix=subPrefix, \
