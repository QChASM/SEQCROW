...
class BuildQM(ToolInstance):
    ...
    def _build_ui(self):
        ...
        #batch = self._menu.addMenu("&Batch")
...
class JobTypeOption(QWidget):
    ...
    def setStructure(self, structure):
        ...
        for i in range(self.constrained_atom_table.rowCount() - 1, -1, -1):
            ...
            if atom.deleted or atom not in structure.atoms:
...
class BatchExport(ChildToolWindow):
    ...
    def _build_ui(self):
        ...
        file_browse_layout.addWidget(self.dir_path, 0, 0, Qt.AlignVCenter)
        file_browse_layout.addWidget(self.chk_browse_button, 0, 1, Qt.AlignVCenter)
